    ...
    return (
      ...
      <div className="max-w-[1024px] m-auto flex justify-center items-center">
        <div className="mt-32 text-center">
          ...
          <br />
          <p>For demo purposes, click LOGIN t access the profile and the first room to access the chatroom.</p>
          ...
          <div className=" max-w-[1024px] m-auto md:grid grid-cols-2 gap-8 items-center px-8 mt-20">
            ...
            <div className="col-span-1 pt-8 md:pt-0 text-justify">
              ...
              The wire framing and low fidelity prototype were completed in Figma. I then created a high fidelity prototype following the design using HTML and CSS.
              Finally I used React to create the front-end of the web application.</p>
                <h4 className="  text-[#EA526F] mt-4">What I Learnt</h4>
                <p>When creating my first project I noticed I was repeating myself a lot especially when it came to the CSS, so this time I made sure my codes are DRY.</p>
          ...
          <div className=" max-w-[1024px] m-auto md:grid grid-cols-2 gap-8 items-center px-8 my-20">
            <div className="col-span-1 pt-8 md:pt-0 text-justify">
              ...
              <p>I ran into an issue where no matter what I did I wasn't able to get a 2nd modal to appear but luckily managed to solve the problem with SweetAlert. Firebase also gave me many error messages to solve and is still something I need to study a lot more on. </p>
              <h4 className="  text-[#EA526F] mt-4">What's next for StudyPerks</h4>
              <p>This was a project I really enjoyed creating and plan to complete it with fully functioning chatrooms including a pomodoro timer and games. I would also love to be able to update the profile so that it will display actual stats for each user. </p>
            </div>
            <div>
