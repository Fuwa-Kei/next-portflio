  ...
  return (
    ...
    <div className="max-w-[1024px] m-auto flex justify-center items-center">
      <div className="mt-32 text-center">
        ...
        <h4>Lloyds Bank x Athena (Journey to Net Zero)</h4>
        <p>E-commerce style site that allows chefs to order ingredients from different suppliers while comparing the carbon footprint of each ingredient all in one place</p>
        ...
        <div className=" max-w-[1024px] m-auto md:grid grid-cols-2 gap-8 items-center px-8 mt-20">
          ...
          <div className="col-span-1 pt-8 md:pt-0 text-justify">
              ...
              Finally I used React to create the front-end of the web application.
</p>
